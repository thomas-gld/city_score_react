                    ...
                    <form action="" className="shadow-lg/20 text-2xl m-10 p-5 border-yellow-400 border-2 rounded-2xl bg-linear-to-br from-white to-yellow-200 flex flex-col items-center gap-4">
                        ...
                        <div>
                            <label htmlFor="password2">Confirmer le mot de passe
                                <br></br><input type="text" id="password2" className="border-2 border-black"></input>
                            </label>
                        </div>
                        <div>
                            <button onClick={handleRegister} className="mt-5 bg-yellow-100 hover:bg-linear-to-tr from-yellow-100 to-yellow-300 hover:cursor-pointer border-2 border-yellow-300 m-3 p-3 rounded-xl shadow-lg/10">S'inscrire</button>
                        </div>
                    </form>
                    <div>
